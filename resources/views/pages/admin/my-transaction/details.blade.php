@extends('layouts.admin') @section('title') Dashboard Transaksaksi Detail
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('my-transactions-update', $transaction->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
